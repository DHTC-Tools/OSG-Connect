...
# Usually one is the frontend proxy (/tmp/vofe_proxy form the host certificate), the other is the proxy delegated 
# to the glideins (/tmp/vofe_gi_delegated_proxy from the pilot certificate)
